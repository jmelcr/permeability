...
for n_unsat in 0 8  #`seq 0 17 $n_lipids_tot` $n_lipids_tot 
do
...
gmx grompp -c ${rd}/../prep_eq/conf_${init_conf}.gro  -f ${rd}/../../${mdp_fname} -n ${rd}/index.ndx -p ../system.top -maxwarn 1
gmx mdrun -awh ${rd}/awh_ref_${init_conf}.xvg -nsteps 10000 -v
